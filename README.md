...
本插件 `pm-workflow/skills/` 下的 7 个产品管理 skill 基于以下开源项目改编与扩展，感谢作者 [@deanpeters](https://github.com/deanpeters) 的系统化梳理：
...
- Richard Lawrence & Peter Green 的 [Humanizing Work](https://www.humanizingwork.com/) 拆分用户故事方法论（`epic-breakdown-advisor` skill 基于该方法实现）
